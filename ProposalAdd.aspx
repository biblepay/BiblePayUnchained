<%@ Page Title="Proposal Add" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ProposalAdd.aspx.cs" Inherits="Unchained.ProposalAdd" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
  
    <h2>Welcome to the BiblePay Governance System </h2>
    <h3>Proposal - Add  <small>v1.1</small></h3>
    ...
    <table>
            ...
            <tr>
                ...
                <td><asp:dropdownlist AutoPostBack="true" runat="server" id="ddCharity">   </asp:dropdownlist>   
            </tr>
